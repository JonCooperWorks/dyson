...
**5 MB** on macOS, **6.5 MB** on Linux, **~10.7 MB RSS** at idle (~9 MB proportional), ~30 direct dependencies. The dependency tree is small enough to audit by hand — fewer crates, less supply-chain surface, and a codebase one person can read end to end.
